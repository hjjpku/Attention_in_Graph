...
python main.py  -softmax=global -adj_norm=none -data=COLLAB -num_layers=4 -gcn_layers=8
python main.py  -softmax=global -adj_norm=tanh -data=COLLAB -num_layers=4 -gcn_layers=8 

python main.py  -softmax=neibor -adj_norm=none -data=COLLAB -num_layers=4 -gcn_layers=8
python main.py  -softmax=neibor -adj_norm=tanh -data=COLLAB -num_layers=4 -gcn_layers=8

python main.py  -softmax=global -adj_norm=none -data=PROTEINS -num_layers=4 -gcn_layers=8
python main.py  -softmax=global -adj_norm=tanh -data=PROTEINS -num_layers=4 -gcn_layers=8 

python main.py  -softmax=neibor -adj_norm=none -data=PROTEINS -num_layers=4 -gcn_layers=8
python main.py  -softmax=neibor -adj_norm=tanh -data=PROTEINS -num_layers=4 -gcn_layers=8
