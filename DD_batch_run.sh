...
python main.py -bsize=20 -gcn_norm=0 -softmax=neibor -adj_norm=none -data=ENZYMES
python main.py -bsize=20 -gcn_norm=0 -softmax=neibor -adj_norm=tanh -data=ENZYMES
