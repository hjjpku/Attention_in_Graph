#! /bin/bash
python main.py -softmax=mix -adj_norm=none -khop=1 -tau=5
...
python main.py -softmax=mix -adj_norm=diag -khop=1 -tau=5
...
python main.py -softmax=mix -adj_norm=tanh -khop=1 -tau=5
