...
gcn_opt.add_argument('-slope', type=int, default=1, help='whether to use relu')
...
agcn_opt.add_argument('-diffpool_k', type=int,default=200,help='agcn node keep percent(=k/node_num)')
